...
|---|---|---|---|
| MIG-01 Repository Integration Foundation | NEW_BUILD | existing regression + skeleton | NOT_STARTED |
| MIG-02 Runtime Contracts + Orchestrator | NEW_BUILD | shared runtime envelope | NOT_STARTED |
