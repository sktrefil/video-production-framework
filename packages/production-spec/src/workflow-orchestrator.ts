...
export const STANDARD_PRODUCTION_WORKFLOW: ProductionWorkflowDefinition = {
  ...
  tasks: [
    ...
    task("T030", 30, "TTS / Scene Timing / Subtitle", "Create narration timing, scene/beat timing and subtitle timing from the approved script.", "TTS_TIMING", "AGENT2_STORY_AUDIO", ["T020"], ["story_spec", "script"], ["tts_manifest", "scene_timing_spec", "subtitle_timing"], ["TTS_POLICY_V1", "SCENE_TIMING_POLICY_V1"], "STORY_AUDIO_GATE", true),
    task("T040", 40, "Visual Scene Planning", "Translate the approved story and facts into scene-level visual intent, factuality and continuity.", "VISUAL_SCENE_PLAN", "AGENT3_VISUAL_PRODUCTION", ["T030"], ["scene_timing_spec", "story_spec", "fact_check_spec", "visual_bible"], ["scene_visual_spec"], ["VISUAL_BIBLE_POLICY_V1", "CONTINUITY_POLICY_V1", "FACTUALITY_POLICY_V1"], "VISUAL_PLAN_GATE", true),
    ...
    task("T060", 60, "Clip / Camera Planning", "Allocate clip durations, core-point timing, camera direction, transitions and compile provider prompts.", "CLIP_CAMERA_PLAN", "AGENT3_VISUAL_PRODUCTION", ["T030", "T040", "T050"], ["scene_timing_spec", "scene_visual_spec", "state_image_spec", "visual_bible"], ["clip_production_spec", "prompt_bundle_spec"], ["CLIP_DURATION_POLICY_V1", "CORE_POINT_POLICY_V1", "CAMERA_POLICY_V1", "CONTINUITY_POLICY_V1", "PROMPT_COMPILER_POLICY_V1"], "CLIP_PLAN_GATE", true),
