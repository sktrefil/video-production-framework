...
const GenericEditorRuntime:FC=()=>{const {state}=useStudioEditor();return <><ProjectRenderer project={state.project}/><StudioGraphicsCanvasOverlay/><StudioSubtitleCanvasOverlay/><StudioEditor/></>;};
